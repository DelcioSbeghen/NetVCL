...
const
  aNVRegionBack: array [bsrbDefault .. bsrbDanger] of string = ('default', 'primary', 'success',
    'info', 'warning', 'danger');

type
  TNVRegionType = (bsrtNone, bsrtContainer, bsrtContainerFluid, bsrtRow, bsrtColumn, bsrtDropDown,
    ...
    bsrtPanelFooter, bsrtCard, bsrtCardBlock, bsrtCardHeader, bsrtCardFooter, bsrtCardGroup);

const
  aNVRegionType: array [bsrtNone .. bsrtCardGroup] of string = ('', 'container', 'container-fluid',
    'row', 'column', 'dropdown', 'dropdown-menu', 'form-group', 'jumbotron', 'page-header', 'well',
    'well well-lg', 'well well-sm', 'btn-toolbar', 'list-group', 'modal-content', 'modal-header',
    'modal-body', 'modal-footer', 'panel-group', 'panel', 'panel-body', 'panel-heading',
    'panel-footer', 'card', 'card-block', 'card-header', 'card-footer', 'card-group');

type
  TNVRegionTagType = (bsttDiv, bsttH1, bsttH2, bsttH3, bsttH4, bsttH5, bsttH6, bsttP);

const
  aNVRegionTagType: array [bsttDiv .. bsttP] of string = ('div', 'h1', 'h2', 'h3', 'h4', 'h5',
    'h6', 'p');
