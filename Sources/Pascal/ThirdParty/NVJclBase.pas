...
{**************************************************************************************************}
{                                                                                                  }
{ Last modified: $Date:: 2015-09-15 14:45:45 +0200                                               $ }
{ Revision:      $Rev:: 9b66a8e055529e92628d7f07e6206dae091a7a02                                 $ }
...
type
  ...
  PPWideChar = ^NVJclBase.PWideChar;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: jcl/source/common/JclBase.pas $';
    Revision: '$Revision: 9b66a8e055529e92628d7f07e6206dae091a7a02 $';
    Date: '$Date: 2015-09-15 14:45:45 +0200 $';
...
begin
  if Value <> '' then
    Result := NVJclBase.BytesOf(AnsiString(Value))
  else
    SetLength(Result, 0);
end;
...
begin
  Result := NVJclBase.BytesOf(WideString(Value));
end;
