...
{**************************************************************************************************}
{                                                                                                  }
{ Last modified: $Date:: 2015-11-15 10:52:32 +0100                                               $ }
{ Revision:      $Rev:: 4ec204493293be0630eafae5d57f49acc1073486                                 $ }
...
const
  ...
  NativeTab = Char(#9);
  NativeLineFeed = NVJclBase.NativeLineFeed;
  NativeVerticalTab = Char(#11);
  NativeFormFeed = Char(#12);
  NativeCarriageReturn = NVJclBase.NativeCarriageReturn;
  NativeCrLf = NVJclBase.NativeCrLf;
  NativeSo = Char(#14);
  NativeSi = Char(#15);
  NativeDle = Char(#16);
  NativeDc1 = Char(#17);
  ...
  NativeLineBreak = NVJclBase.NativeLineBreak;
...
type
  PMultiSz = PChar;
  PAnsiMultiSz = NVJclAnsiStrings.PAnsiMultiSz;
  //DELCIO PWideMultiSz = JclWideStrings.PWideMultiSz;

  TAnsiStrings = NVJclAnsiStrings.TJclAnsiStrings;
  //DELCIO TWideStrings = JclWideStrings.TJclWideStrings;
  TAnsiStringList = NVJclAnsiStrings.TJclAnsiStringList;
 //DELCIO  TWideStringList = JclWideStrings.TJclWideStringList;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: jcl/source/common/JclStrings.pas $';
    Revision: '$Revision: 4ec204493293be0630eafae5d57f49acc1073486 $';
    Date: '$Date: 2015-11-15 10:52:32 +0100 $';
...
uses
  ...
  NVJclLogic, NVJclResources, {DELCIO JclStreams,} NVJclSynch, NVJclSysUtils;
...
begin
  ...
  try
    ...
    Start := Pointer(S);
    repeat
      Done := NVJclStrings.StrWord(Start, Token);
      if Token <> '' then
        List.Add(Token);
    until Done;
  finally
