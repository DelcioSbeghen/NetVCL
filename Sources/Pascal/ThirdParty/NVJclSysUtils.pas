...
{**************************************************************************************************}
{                                                                                                  }
{ Last modified: $Date:: 2016-08-07 15:22:52 +0200                                               $ }
{ Revision:      $Rev:: 3850894d3261136797ba7eeb47bd2dd067198af2                                 $ }
...
type
 ...
 (*DELCIO  TJclNumericFormat = class(TObject)
  private
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: jcl/source/common/JclSysUtils.pas $';
    Revision: '$Revision: 3850894d3261136797ba7eeb47bd2dd067198af2 $';
    Date: '$Date: 2016-08-07 15:22:52 +0200 $';
...
uses
  ...
  {$ENDIF HAS_UNIT_ANSISTRINGS}
  {$ENDIF ~HAS_UNITSCOPE}
  NVJclFileUtils, {DELCIO JclMath,} NVJclResources, NVJclStrings,
  NVJclStringConversions, NVJclSysInfo, NVJclWin32;
...
begin
  if Assigned(FOutputCallback) then
    Result := NVJclSysUtils.Execute(Format('"%s" %s', [ExeName, CommandLine]), FOutputCallback) = 0
  else
    Result := NVJclSysUtils.Execute(Format('"%s" %s', [ExeName, CommandLine]), FOutput) = 0;
end;
