...
{**************************************************************************************************}
{                                                                                                  }
{ Last modified: $Date:: 2015-09-21 20:19:08 +0200                                               $ }
{ Revision:      $Rev:: d624fd26242bda437c36ce9914c9017e02085ce2                                 $ }
...
type
  ...
  public
   ...
   //DELCIO class function GetSpinTimeOut: Cardinal;
    //DELCIO class procedure SetSpinTimeOut(const Value: Cardinal);
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: jcl/source/common/JclSynch.pas $';
    Revision: '$Revision: d624fd26242bda437c36ce9914c9017e02085ce2 $';
    Date: '$Date: 2015-09-21 20:19:08 +0200 $';
...
uses
  ...
  SysUtils,
  {$ENDIF ~HAS_UNITSCOPE}
  NVJclLogic, {DELCIO JclRegistry,} NVJclResources,
  NVJclSysInfo, NVJclStrings;
...
{ DELCIO class function TJclCriticalSectionEx.GetSpinTimeOut: Cardinal;
begin
...
{DELCIO class procedure TJclCriticalSectionEx.SetSpinTimeOut(const Value: Cardinal);
begin
...
begin
  inherited Create;
  FName := Name;
  FHandle := NVJclWin32.CreateMutex(SecAttr, InitialOwner, PChar(Name));
  if FHandle = 0 then
