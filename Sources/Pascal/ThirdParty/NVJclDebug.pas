...
{**************************************************************************************************}
{                                                                                                  }
{ Last modified: $Date:: 2016-08-06 13:56:01 +0200                                               $ }
{ Revision:      $Rev:: accabb740360cc81d7e252b8702a4da7ebcddfd4                                 $ }
...
uses
  ...
  {$ENDIF ~HAS_UNITSCOPE}
  NVJclBase, NVJclFileUtils, NVJclPeImage,
  {$IFDEF BORLAND}
  NVJclTD32,
  {$ENDIF BORLAND}
  NVJclSynch;
...
// Miscellanuous
{$IFDEF MSWINDOWS}
//DELCIO function EnableCrashOnCtrlScroll(const Enable: Boolean): Boolean;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: jcl/source/windows/JclDebug.pas $';
    Revision: '$Revision: accabb740360cc81d7e252b8702a4da7ebcddfd4 $';
    Date: '$Date: 2016-08-06 13:56:01 +0200 $';
...
uses
  ...
  Registry,
  {$ENDIF MSWINDOWS}
  NVJclHookExcept, NVJclAnsiStrings, NVJclStrings, NVJclSysInfo, NVJclSysUtils, NVJclWin32,
  NVJclStringConversions, NVJclResources;
...
type
  ...
  TSymGetSymFromAddrAFunc = function (hProcess: THandle; dwAddr: DWORD;
    pdwDisplacement: PDWORD; var Symbol: NVJclWin32.TImagehlpSymbolA): Bool; stdcall;
  TSymGetSymFromAddrWFunc = function (hProcess: THandle; dwAddr: DWORD;
    pdwDisplacement: PDWORD; var Symbol: NVJclWin32.TImagehlpSymbolW): Bool; stdcall;
  TSymGetModuleInfoAFunc = function (hProcess: THandle; dwAddr: DWORD;
    var ModuleInfo: NVJclWin32.TImagehlpModuleA): Bool; stdcall;
  TSymGetModuleInfoWFunc = function (hProcess: THandle; dwAddr: DWORD;
    var ModuleInfo: NVJclWin32.TImagehlpModuleW): Bool; stdcall;
  ...
  TSymGetLineFromAddrAFunc = function (hProcess: THandle; dwAddr: DWORD;
    pdwDisplacement: PDWORD; var Line: NVJclWin32.TImageHlpLineA): Bool; stdcall;
  TSymGetLineFromAddrWFunc = function (hProcess: THandle; dwAddr: DWORD;
    pdwDisplacement: PDWORD; var Line: NVJclWin32.TImageHlpLineW): Bool; stdcall;
  {$ENDIF CPU32}
  {$IFDEF CPU64}
  TSymGetSymFromAddrAFunc = function (hProcess: THandle; dwAddr: DWORD64;
    pdwDisplacement: PDWORD64; var Symbol: NVJclWin32.TImagehlpSymbolA64): Bool; stdcall;
  TSymGetSymFromAddrWFunc = function (hProcess: THandle; dwAddr: DWORD64;
    pdwDisplacement: PDWORD64; var Symbol: NVJclWin32.TImagehlpSymbolW64): Bool; stdcall;
  TSymGetModuleInfoAFunc = function (hProcess: THandle; dwAddr: DWORD64;
    var ModuleInfo: NVJclWin32.TImagehlpModuleA64): Bool; stdcall;
  TSymGetModuleInfoWFunc = function (hProcess: THandle; dwAddr: DWORD64;
    var ModuleInfo: NVJclWin32.TImagehlpModuleW64): Bool; stdcall;
  TSymLoadModuleFunc = function (hProcess: THandle; hFile: THandle; ImageName,
  ...
  TSymGetLineFromAddrAFunc = function (hProcess: THandle; dwAddr: DWORD64;
    pdwDisplacement: PDWORD; var Line: NVJclWin32.TImageHlpLineA64): Bool; stdcall;
  TSymGetLineFromAddrWFunc = function (hProcess: THandle; dwAddr: DWORD64;
    pdwDisplacement: PDWORD; var Line: NVJclWin32.TImageHlpLineW64): Bool; stdcall;
  {$ENDIF CPU64}
  ...
  begin
    ...
    try
      ...
      begin
        ...
        NVJclPeImage.UnDecorateSymbolName(string(PWideChar(@SymbolW^.Name[0])), Info.ProcedureName, UNDNAME_NAME_ONLY or UNDNAME_NO_ARGUMENTS);
      end;
    finally
      FreeMem(SymbolW);
    end;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        Info.BinaryFileName := FileName;
        Info.OffsetFromProcName := Displacement;
        NVJclPeImage.UnDecorateSymbolName(string(PAnsiChar(@SymbolA^.Name[0])), Info.ProcedureName, UNDNAME_NAME_ONLY or UNDNAME_NO_ARGUMENTS);
      end;
    finally
      FreeMem(SymbolA);
    end;
