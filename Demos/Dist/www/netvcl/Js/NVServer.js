...
var TServer = /** @class */ (function() {
    function TServer(async, atimeout) {
        this.timeout = 20000;
        this.CallType = "POST";
        this.async = true;
        if (async != null)
    ...
    TServer.prototype.getHTML = function(filename, callback, errorCallback) {
        ...
        var ajxParam = {
            ...
            success: function(data, textStatus, jqXHR) {
                var myData = new ServerCacheItem();
                myData.data = data;
    ...
    TServer.prototype.ping = function(okCallback, errorCallback) {
        var ajxParam = {
            async: this.async,
            timeout: 1000,
            cache: false,
            url: V.Application.serverURL,
            dataType: "json",
    ...
    TServer.prototype.send = function(method, param, callback, errorCallback, cacheTimeOut) {
        if (cacheTimeOut === void 0) { cacheTimeOut = -1; }
        var data = encodeURIComponent(JSON.stringify(param));
        if (cacheTimeOut > 0) {
    ...
    TServer.prototype.callServerMethod = function(method, param, callback, errorCallback) {
        var data = encodeURIComponent(JSON.stringify(param, function(key, value) {
    ...
    TServer.prototype.callJSONP = function(serverURL, param, callback, errorCallback) {
        var data = encodeURIComponent(JSON.stringify(param, function(key, value) {
            if (key === "__ownerCollection")
                return undefined;
            return value;
...
var ServerCacheItem = /** @class */ (function() {
    function ServerCacheItem() {}
    return ServerCacheItem;
}());
